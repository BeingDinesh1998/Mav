...
componentDidMount(){
  ...
  <div class="image-search">
    <img  src={imagePreviewUrl} class="ui image"/>
  </div>
</div>
<div>
...
<div class="ui bottom attached segment pushable">
  <div class="ui visible left vertical sidebar menu">
    ...
    <div class="upload-container">
        <div class="upload" onClick={() => this.fileInputRef.current.click()}>+</div>
        <button class="ui primary button"  onClick={() => this.fileInputRef.current.click()}>UPLOAD AND DETECT FACE
        <input
