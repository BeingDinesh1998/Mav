...
export default function GroupByLocation(){
  ...
  async function callApi () {
    const response = await fetch('/api/getGroupAssociation');
...
<div class="location-container">
  ...
  <SemanticDatepicker onChange={handleDateChange} />
      ...
      <div class="filter-btn h-100">
                ...
                <Link to='/suspectInteraction'><button class="ui primary button apply-filter">APPLY</button></Link>
                </div>
                <div class="filter-buttons">
